...
config.set_section_option(section, "DB_HOST", DB_HOST) # подгрузка из .env
config.set_section_option(section, "DB_PORT", DB_PORT) # подгрузка из .env
config.set_section_option(section, "DB_NAME", DB_NAME) # подгрузка из .env
